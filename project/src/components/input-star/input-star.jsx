...
function InputStar({ data, onInput }) {
  ...
  return (
    <>
      <input onInput={onInput} className="form__rating-input visually-hidden" name="rating" value={ratingInt} id={`${ratingInt}-stars`} type="radio" required data-testid='input-star'/>
