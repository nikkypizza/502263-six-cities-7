...
import FavouritePlace from './favourite-places-list';
...
describe('Component: FavouritePlace', () => {
    ...
    render (
      <Provider store={store}>
        <Router history={history}>
          <FavouritePlace places={ADS}/>
        </Router>
      </Provider>,
    );

    expect(screen.queryAllByTestId('favourites-card')).toHaveLength(ADS.length);
